...
public class Position {
	...
	// heuristic: the euclidean distance between this node and the goal
	public double getEstimatedDistanceToGoal(Position dest){
		
		double dx = Math.abs(dest.getX()- this.X);
		double dy = Math.abs(dest.getY()- this.Y);
